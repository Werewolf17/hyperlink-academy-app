...
This manual describes how it works, and how you can make the most of it. That first sentence is our tagline, copied fresh from the homepage of this very site. Let's dig into what it means!
...
Hyperlink hosts a collection of ***courses*.** Each course is a template for a learning experience, describing a curriculum that will be followed in service of a learning goal.
...
In the same way, courses on Hyperlink are designed to run multiple times, so that with each cohort, the course as a whole becomes more and more effective.
...
For examples of courses and cohorts, check out the list of [Hyperlink Courses](https://hyperlink.academy/#courses)!
