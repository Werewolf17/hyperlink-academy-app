...
1. Find a course you're interested in: [Hyperlink Courses](https://hyperlink.academy/#courses).
2. On the right sidebar, browse the list of upcoming cohorts and select one that works for you. This will take you to the details page for that cohort, where you can enroll.
...
**Congrats — you're now taking a Hyperlink course!**
...
Or, consider facilitating a cohort yourself! Learn more about facilitating and let us know if you have questions. It depends on the course, but many are designed so that anyone can facilitate.