...
We're constantly experimenting on Hyperlink, and using what we learn to improve the platform so that future courses can be even better. As part of this, we regularly run the [Meta Course](https://hyperlink.academy/courses/meta-course) — a free workshop for going from idea to full-fledged curriculum, together with a small group of other course creators.
